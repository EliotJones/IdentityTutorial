namespace XunitTests
{
    ...
    using IdentityTutorial.Data.Mappings;
    using Xunit;

    public class XmlUserMapTests
    {
        private readonly XmlUserMap xmlUserMap = new XmlUserMap();
        private readonly CustomUser customUser = new CustomUser(new Guid("B981CB10-ACF5-4E71-BB89-B1DACA51A825"), "test@test.com", "test@test.com", string.Empty, 0, null, true);
